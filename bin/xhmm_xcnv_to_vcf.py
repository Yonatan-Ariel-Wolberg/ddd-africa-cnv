...
def convert_xhmm_xcnv_to_vcf(input_file, output_dir, combined_vcf_name, log_file, sample_file=None, fai_file=None):
    ...
    try:
        ...
        with open(input_file, 'r') as csv_file:
            ...
            print("XCNV headers:", csv_reader.fieldnames)
    ...
    # Return 'mutations_by_sample' dictionary and 'sample_order' list as a tuple
...
def write_vcf_file(output_file, ref_name, sorted_contig_lines, mutations_by_sample, sample_order, log_file=None):
    ...
    try:
        ...
        with open(output_file, 'w') as vcf_file:
            ...
            vcf_file.write("##source=XHMM_XCNV_TO_VCF\n")
            ...
            vcf_file.write("##INFO=<ID=TOOL,Number=1,Type=String,Description=\"CNV Caller used to call the CNV\">\n")
            ...
            for sample_id in sample_order:
                ...
                for mutation in mutations:
                    try:
                        ...
                        if safe_float(q_some) >= 60 and safe_float(q_exact) >= 60 and safe_float(q_non_diploid) >= 60:
                            filter_status = 'PASS'
                        else:
                        ...
                        vcf_file.write(f"{chr_num}\t{start}\t.\t{ref}\t{alt}\t.\t{filter_status}\tEND={end};SVLEN={svlen};SVTYPE={cnv};TOOL=XHMM;STRANDS={strand}\tGT:Q_SOME")
...
def xhmm_xcnv_to_bed(output_bed_file, mutations_by_sample, sample_order, log_file=None):
    """
...
def main():
    ...
    mutations_by_sample, sample_order = convert_xhmm_xcnv_to_vcf(
    ...
    if mutations_by_sample is not None and sample_order is not None:
        ...
        xhmm_xcnv_to_bed(args.bed_file, mutations_by_sample, sample_order, args.log_file)
